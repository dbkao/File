...
init:
    ...
    screen Gallery():
        ...
        tag menu
        add "images/Gallery.png"
        grid 3 2:

            xfill True
            yfill True

            add g.make_button("cg1", "images/1-1.png", xalign = 0.5, yalign = 0.7)
            add g.make_button("cg2", "images/2-1.png", xalign = 0.5, yalign = 0.7)
            add g.make_button("cg3", "images/3-1.png", xalign = 0.5, yalign = 0.7)
            add g.make_button("cg4", "images/4-1.png", xalign = 0.5, yalign = 0.3)
            add g.make_button("cg5", "images/5-1.png", xalign = 0.5, yalign = 0.3)
            add g.make_button("cg6", "images/6-1.png", xalign = 0.5, yalign = 0.3)
        
        textbutton _(">") action Show("Gallery2"):
            xalign 1200
            yalign 900

        textbutton '돌아가기' action Return() xpos 1750 ypos 1000    
    ...
    screen Gallery2():
        ...
        grid 2 2:
            ...
            add g.make_button("cg7", "images/7-1.png", xalign = 0.5, yalign = 0.7)
            add g.make_button("cg8", "images/8-1.png", xalign = 0.5, yalign = 0.7)
            add g.make_button("cg9", "images/9-1.png", xalign = 0.5, yalign = 0.3)
            add g.make_button("cg10", "images/10-1.png", xalign = 0.5, yalign = 0.3)
